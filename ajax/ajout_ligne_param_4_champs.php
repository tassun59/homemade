...
$chpAUpdater3 = $_GET["chpAUpdater3"];
$valeur3 = $_GET["valeur3"];
$chpAUpdater4 = $_GET["chpAUpdater4"];
$valeur4 = $_GET["valeur4"];
...
try
{
	...
	$result_t_param = $bdd->prepare("INSERT INTO ".$NomTable." (".$chpAUpdater.", ".$chpAUpdater2.", ".$chpAUpdater3.", ".$chpAUpdater4.") value (:valeur, :valeur2, :valeur3, :valeur4);");
	$result_t_param->bindParam(":valeur",$valeur);
	$result_t_param->bindParam(":valeur2",$valeur2);
	$result_t_param->bindParam(":valeur3",$valeur3);
	$result_t_param->bindParam(":valeur4",$valeur4);
